        ...
        <div className="bg-bg-surface border border-border-card rounded-2xl p-8 shadow-xl">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-bg-surface px-2 text-brand-muted">Or continue with</span>
            </div>
          </div>
          ...
          <button
            ...
            type="button"
            className="w-full py-2.5 bg-white hover:bg-gray-100 text-black rounded-lg font-semibold transition-colors flex items-center justify-center gap-2 mb-6"
          >
