...
import { UrlMonitorWizardSkeleton } from "../../../src/components/shared/PageSkeleton";
    ...
    if (formData.url && currentStep === 1) {
      ...
      if (!formData.name) {
        try {
          ...
          if (suggestedName)
            setFormData((p) => ({ ...p, name: suggestedName }));
        } catch (e) {}
      }
                  ...
                  <div className="space-y-10">
                    <div className="space-y-4">
                      ...
                      <p className="text-center text-[10px] text-brand-muted font-medium">
                        ...
                        <span className="text-text-primary">{requestsPerMonth}</span>{" "}
                        checks per month.
                      </p>
                    </div>
                        ...
                        <ChannelPillLarge
                          ...
                          onClick={() =>
                            setFormData((p) => ({
                              ...
                              alert_channels: {
                                ...p.alert_channels,
                                telegram: !p.alert_channels.telegram,
                              },
                            }))
                          }
                        />
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <p className="text-[10px] text-brand-muted leading-relaxed">
                            Wait for multiple failures before alerting to avoid
                            noise from network blips.
                          </p>
                          <select
                  ...
                  <div className="space-y-6">
                    <div className="p-8 rounded-3xl bg-bg-surface border border-border-card space-y-8">
                      ...
                      <div className="grid grid-cols-2 gap-10">
                        ...
                        <SummaryItem
                          label="Channels"
                          value={Object.entries(formData.alert_channels)
                            .filter(([_, v]) => v)
                            .map(
          ...
          <div className="w-full max-w-xl flex items-center justify-between px-6">
            ...
            {currentStep < 4 ? (
              ...
              <button
                ...
                className="px-8 py-2.5 bg-brand-primary hover:bg-brand-primary/90 text-white rounded-xl text-[11px] font-bold transition-all flex items-center gap-2 shadow-xl shadow-brand-primary/20 active:scale-[0.98]"
              >
                {isSubmitting ? (
