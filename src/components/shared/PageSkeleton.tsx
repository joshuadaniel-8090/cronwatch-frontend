    ...
    <div className="min-h-screen bg-bg-base flex overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        <div className="p-4 md:p-8 flex-1 overflow-y-auto custom-scrollbar">
          <div className="max-w-350 mx-auto grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_20rem] gap-6 lg:gap-8 pb-24">
            <div className="space-y-6">
              <section className="rounded-[1.75rem] border border-border-card bg-bg-surface/80 p-5 md:p-6">
